...
const Page = () => {
  ...
  const images = [
    "/assets/dp/fitness1.png",
    "/assets/dp/fitness2.png",
    "/assets/dp/fitness.png",
    "/assets/dp/fitness3.png",
    "/assets/dp/FITNES4.png",
  ];
    ...
    <div>
      ...
      <div className="md:pt-40 md:pl-20 pt-28 pl-8 pr-8 flex md:gap-96">
        <div className="lg:w-1/2 w-3/4">
          <h1 className="font-bold text-left text-4xl text-violet-500 md:text-5xl lg:text-7xl pb-4">
            Fitness
          </h1>
        ...
        {/* Logo */}
        <div className="w-1/4 flex bg-violet-500 mb-96 md:mb-60 md:ml-12 md:mr-12 rounded-xl justify-center items-start">
          <Image src="/assets/dp/LOGOFITNESS.png" alt="Logo " width={120} height={100} />
        </div>
      </div>
