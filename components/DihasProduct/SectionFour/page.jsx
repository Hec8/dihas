        ...
        <div className="lg:w-2/3 md:w-3/5 flex flex-col lg:pl-12 lg:pl-12 gap-4 lg:gap-16 lg:p-10">
          ...
          <div className="flex justify-center w-full mt-auto">
            <button
              ...
              className="relative mx-auto block justify-center items-center text-stone-50 text-md lg:text-xl w-60 py-2 lg:py-4 lg:w-72 lg:px-4 lg:py-4 lg:rounded-2xl rounded-xl font-bold transition duration-300 overflow-hidden group"
            >
